...
public class ConfigReader {
     ...
     * The method getProperty(String key) will fetches the values from Configuration.properties file.
     * using the key provided as an paremeter.
     *
     */
...
String path = System.getProperty("user.dir")+"/src/test/resources/configurations/Configuration.properties";
        try {
            ...
            try {
                ...
                System.out.println("Exception occured when trying to close input object");
            }
        }
